...
\titleTH{การจัดการซัพพลายเชนด้วยบล็อกเชนและไอโอที}
\titleEN{Blockchain and IoTs in Supply Chain Management}

% จัดแนวชื่อทั้งภาษาไทยและภาษาอังกฤษให้ตรงกัน (ใช้ \makebox บังคับความกว้างกล่องและสั่งชิดซ้าย [l])
\author{\makebox[6.5cm][l]{นางสาวนันท์นภัส ศิริธนาโชคไพศาล}}{\makebox[6.0cm][l]{Nunnapat Sirithanachokpaisan}}{650610776}
\author{\makebox[6.5cm][l]{นางสาวปิ่นนารี พร้อมมิตร}}{\makebox[6.0cm][l]{Pinnaree Prommitr}}{650610785}
\author{\makebox[6.5cm][l]{นายผืนป่า จำปาศรี}}{\makebox[6.0cm][l]{Phuenpa Champasri}}{650612090}
...
% ==================== คนที่ 1 ====================
\begin{center}
  \includegraphics[width=1.5in]{nunnapat.JPG} 
\end{center}
\vspace{1em}
